...
def parse_arguments():
    parser = argparse.ArgumentParser(description="DAMNETS - A Deep Autoregressive Markovian NTS Generator")
    ...
    parser.add_argument(
        ...
        "--series_generation",
        type=bool,
        help="If true, will generate the full series for the dataset otherwise will predict one snapshot ahead. Only needed for test.",
        default=False,
    )
...
def main():
    ...
    if c_args.test:
        ...
        args.series_generation = c_args.series_generation
